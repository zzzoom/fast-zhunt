...
void show_probability(unsigned seqlength, float* dl, float* slope,
                      float* probability, char* sequence, char** antisyn, char* filename);
...
int main(int argc, char* argv[])
{
    ...
    /*  random_distribution( a, dinucleotides, min, max, (char *) argv[4] ); */
...
void analyze_zscore(char* filename)
{
    ...
    show_probability(seqlength, dl, slope, probability, sequence, antisyn, filename);
